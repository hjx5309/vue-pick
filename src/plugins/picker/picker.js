...
(function (window, document, Math) {
    ...
    function Scroll(id, params) {
        ...
        console.log("scrollHeight",this.scrollerHeight);
        console.log("childNodeHeight",this.childNodeHeight);
    ...
    Scroll.prototype = {
        ...
        _end: function () {
            ...
            self.scroller.addEventListener('touchend', function (e) {
                ...
                console.log("touches",touches.pageY);
                ...
                if( (self.offsetTop > 0) || (Math.abs(self.offsetTop) > Math.abs(self.scrollHeight)) ){
                    ...
                    console.log("self.offsetTopX",self.offsetTop)
                    ...
                    console.log("self.offsetTopY",self.offsetTop)
                ...
                if( self.options.step && self.stepLen > 0 ){
                    ...
                    console.log("offsetTop1",self.offsetTop)
